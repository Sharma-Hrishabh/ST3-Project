         ...
         <div class="container">
          <div class="col-lg-12 col-md-4">
             <div class="row">
               ...
               <img class="img-responsive" src="../images/plus.png" style="height:200px;margin:auto;margin-bottom:10px;">
...
$query='SELECT * FROM medicalitems ORDER by id ASC';
 ...
 if(mysqli_num_rows($result)>0):
 	while($product=mysqli_fetch_assoc($result)):
 		...
 		<div class="col-sm-4 col-md-3" style="margin-top: 160px">
 			<form method="post" action="medical.php?action=add&id=<?php echo $product['id']; ?>">
                        <div class="products">
...
?><div style="clear:both"></div>
        ...
        <tr>
           ...
           <td>
               <a href="medical.php?action=delete&id=<?php echo $product['id']; ?>">
