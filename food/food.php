        ...
        <div class="navbar-collapse collapse navbar-right">
          <ul class="nav navbar-nav">
           ...
           <?php if(isset($_SESSION['logged_in']))
            ...
            ?>
            <li class="dropdown">
              <a href="../index.php" class="dropdown-toggle" data-toggle="dropdown">STORES<b class="caret"></b></a>
    ...
    <div id="headerwrap">
         <div class="container">
          <div class="col-lg-12 col-md-4">
             <div class="row">
               <h3>Food Shop</h3>
               <img class="img-responsive" src="../images/fl.jpg" style="width:50%; margin:auto;margin-bottom:10px;">
 ...
 if(mysqli_num_rows($result)>0):
 	while($product=mysqli_fetch_assoc($result)):
 		...
 		<div class="col-sm-4 col-md-3" style="margin-top: 160px">
 			<form method="post" action="food.php?action=add&id=<?php echo $product['id']; ?>">
                        <div class="products">
...
?><div style="clear:both"></div>
        ...
        <tr>
           ...
           <td>
               <a href="food.php?action=delete&id=<?php echo $product['id']; ?>">
